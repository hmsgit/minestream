 ...
 * @author mahmud
 */
public class BayesianStream implements InstanceStream {

    public Instances trainingSet;           // training stream for the models
                                            // updated over time, instances are deleted after training
    public Instances newInstances;          // saves temporary new training instances

    public Instances unfilteredTrainingSet; // contains all unfiltered training instances from the beginning
    public int numInstances;                       // number of training instances left in the training stream

    /**
     * Filter for the vector tf*idf representation of the instances
     *
     * @param tweets training tweets for the stream
     */
    StringToWordVector vector;

    public BayesianStream(ArrayList<Tweet> tweets) throws Exception {
...
//			System.out.println("What's the Tweet's date?: " + tweet.getDate());
            ...
            String parseString = "YYYY-MM-dd HH:mm:ss";
     ...
     *
     * @param t - new training instance
     */
    public void addInstanceToStream(Tweet t) {
        Instance inst = new DenseInstance(2);
    ...
    /**
     * Method generates a new temporary dataset for storage of new training
     * tweets
     */
