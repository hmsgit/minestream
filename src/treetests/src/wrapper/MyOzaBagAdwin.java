 ...
 * a well-speciï¬�ed way the problem of tracking the average of
 ...
 * with the hypothesis â€œthere has been no change in the average value
 * inside the windowâ€�.<br />
 ...
 *
 * Albert Bifet and Ricard GavaldÃ . Learning from time-changing data
 ...
 * conï¬�dence bound Î´, indicating how conï¬�dent we want to be in the algorithmâ€™s
 ...
 * classiï¬�er of the ensemble of classiï¬�ers is removed and a new classiï¬�er is
 * added to the ensemble.</p>
 * <p>See details in:<br />
 * [BHPKG] Albert Bifet, Geoff Holmes, Bernhard Pfahringer, Richard Kirkby,
 * and Ricard GavaldÃ  . New ensemble methods for evolving data streams.
 * In 15th ACM SIGKDD International Conference on Knowledge Discovery and
 * Data Mining, 2009.</p>
 * <p>Example:</p>
 * <code>MyOzaBagAdwin -l HoeffdingTreeNBAdaptive -s 10</code>
 * <p>Parameters:</p> <ul>
 ...
 * @version $Revision: 7 $
 */
public class MyOzaBagAdwin extends AbstractClassifier {
    ...
    private int[] resetCount = new int[ensembleSizeOption.getValue()];
    ...
    public void resetLearningImpl() {
        ...
        resetCount = new int[ensembleSizeOption.getValue()];
    }
    ...
    public double getResetCount() {
        int sum = 0;
        for(int a: resetCount)
            sum+= a;
        double ret = (double) sum / this.ensembleSizeOption.getValue();
