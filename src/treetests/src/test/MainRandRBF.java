...
//        
        ...
        new MainRandRBF().test_OzaBagAdaHT_RandRBF();
        new MainRandRBF().test_OzaBagASHT_RandRBF();
        new MainRandRBF().test_OzaBagAdwin_RandRBF();
//        
        new MainRandRBF().test_OzaBoostHT_RandRBF();
        new MainRandRBF().test_OzaBoostAdaHT_RandRBF();
        //new Main().test_OzaBoostAdwin_RandRBF();
        
        
        new MainRandRBF().test_OzaBagSRHT_RandRBF();
