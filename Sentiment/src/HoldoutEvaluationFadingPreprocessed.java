...
public class HoldoutEvaluationFadingPreprocessed {
    ...
    private final static double DECAYDEGREE = 0.000003;
	...
	public static void main(String[] args) throws Exception {
        ...
        WritableWorkbook workbook = Workbook.createWorkbook(new java.io.File("output-holdout-fading-preprocessed-"+DECAYDEGREE+".xls"));
...
//		learner.prepareForUse();
        ...
        */
        ...
        System.out.println("Holdout Fading Preprocessed " + (numberSamples-firstPart)+" instances processed with "+accuracy+"% accuracy and fading degree " + DECAYDEGREE);
