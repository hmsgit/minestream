 ...
 */
public class ExtendedDatabaseConnectionPreprocessed {
	 ...
	 */
	public ExtendedDatabaseConnectionPreprocessed(String db, String user, String password) throws SQLException, ClassNotFoundException, IOException{
