...
public class PrequentialEvaluationAggressivePreprocessedExcel {
    ...
    //private final static int OUTPUT_FREQUENCY = 2500;
    private final static int EVALUATOR_WINDOW = 1000;
    ...
    public static double classify(double decaydegree) throws Exception {
        WritableWorkbook workbook = Workbook.createWorkbook(new java.io.File("output-prequential-agg-preprocessed-day-" + decaydegree + "-" + EVALUATOR_WINDOW + ".xls"));
...
//		Define new performance evaulator
        ...
        //System.out.println(numberSamples+" instances processed with accumulative "+accuracy+"% accuracy");
    ...
    public static void main(String[] args) throws Exception {
        double decay1 = 0.2;
        //double decay2 = 0.00001;
        //double decay3 = 0.00005;
        ...
        System.out.println("Preprocessed Aggressive Prequential Evaluation classified with decayDegree " + decay1 + " and accuracy " + accuracy1);
