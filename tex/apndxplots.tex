...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of drift coefficient on Kappa statistics  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of drift coefficient on tree depth  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of drift coefficient on tree size  using (a) random RBF (b) VS RBF}
        \label{fig:apndeffect:speed2}
    \end{center}
\end{figure}
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of drift coefficient on used memory  using (a) random RBF (b) VS RBF}
        \label{fig:apndeffect:speed2}
    \end{center}
\end{figure}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of grace period on tree depth  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of grace period on used memory  using (a) random RBF (b) VS RBF}
        \label{fig:apndeffect:grace2}
    \end{center}
\end{figure}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of number of centroids on used memory  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of percentage of drift centroids on processing time  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of percentage of drift centroids on tree size  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of percentage of drift centroids on used memory  using (a) random RBF (b) VS RBF}
        \label{fig:apndeffect:driftcentroid2}
    \end{center}
\end{figure}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of tie threshold on processing time  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of tie threshold on tree depth  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of binary split centroids on accuracy  using (a) random RBF (b) VS RBF}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of binary split centroids on processing time  using (a) random RBF (b) VS RBF}
        \label{fig:apndeffect:binsplit1}
    \end{center}
\end{figure}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of binary split on used memory  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of maximum allowed size of tree on accuracy  using (a) random RBF (b) VS RBF}
...
\begin{figure}[H] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of ensemble size on tree depth  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of ensemble size on tree size  using (a) random RBF (b) VS RBF}
        \label{fig:apndeffect:ensize2}
    \end{center}
\end{figure}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of tree reset (within ensemble) on accuracy  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{Effect of first tree size centroids on accuracy  using (a) random RBF (b) VS RBF}
...
\begin{figure}[htbp] 
    \begin{center}
        ...
        \end{tabular}
        \caption{(a,c) time, (b,d) tree size over time for (a,b) random RBF, (c,d) VS RBF}
